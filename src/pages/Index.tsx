...
import { Users, Package, BarChart3, ArrowRight, Target, TrendingUp, Zap } from "lucide-react";
...
const Index = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-24 text-center">
        ...
        <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground"> Analyze products using actual swipe behaviors from the SWIRL. app, predict purchase intent with behavioral precision, and optimize pricing strategies based on observed consumer preferences and elasticity..</p>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {features.map(feature => <Card key={feature.title} className="border-border/50 transition-shadow hover:shadow-lg">
              <CardHeader>
      ...
      <section className="border-y bg-muted/30 py-16">
        <div className="container mx-auto px-4">
          <div className="grid gap-8 sm:grid-cols-3">
            ...
            <div className="text-center">
              <div className="mb-2 text-4xl font-semibold">2O M+</div>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Set up your brand profile.</p>
          </div>
          <div className="text-center">
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-primary text-2xl font-semibold text-primary-foreground">
              2
